...
emotion_model_path = 'models/model_class.hdf5'
#emotion_model_path = 'models/OK/11-2-tf1.13_LAST.hdf5'

# hyper-parameters for bounding boxes shape
# loading models
#emotion_classifier = load_model(emotion_model_path, compile=False)
#emotion_classifier = tf.keras.models.load_model(emotion_model_path, compile=False)
#emotion_classifier = tf.keras.models.load_model(emotion_model_path, compile=False, custom_objects = {'LayerNormalization':LayerNormalization, 'tf':tf})
emotion_classifier = tf.keras.models.load_model(emotion_model_path, compile=False, custom_objects = {'tf':tf})


#EMOTIONS = ["angry" ,"disgust","scared", "happy", "sad", "surprised","neutral"]

EMOTIONS = ['Mask', 'No_mask']
...
#vout = cv2.VideoWriter(video_name,cv2.VideoWriter_fourcc('M','J','P','G'), 10 ,(640,480))
...
if __name__ == '__main__':
    ...
    #while 1:
        ...
        frames = "frames = {:.1f}".format(n)

        cv2.putText(img_raw, fps_det, (10, 400),
                    cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 255, 255))

        #cv2.putText(img_raw, frames, (10, 280),
        #            cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 255, 255))
        ...
        for b in dets:
            ...
            for (i, (emotion, prob)) in enumerate(zip(EMOTIONS, preds)):
                ...
                if label == 'Mask':
                    ...
                    #cv2.rectangle(img_raw, (b[0], b[1]), (b[2], b[3]), (160, 0, 255), 2)
                    overlay = img_raw.copy()
                    cv2.rectangle(img_raw, (b[0], b[1]), (b[2], b[3]), (160, 0, 255), -1)
                    alpha = 0.9
                    cv2.addWeighted(overlay, alpha, img_raw, 1 - alpha, 0, img_raw)
